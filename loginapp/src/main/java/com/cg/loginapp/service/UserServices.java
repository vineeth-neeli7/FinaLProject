...
public class UserServices {
	...
	/*public static boolean isValid(final String date) {
       ...
       // Matcher matcher = pattern.matcher(date);
        Matcher mDob = pDob.matcher(udto.getDob());
        if (matcher.matches()) {
	...
	public boolean validation(UserDTO udto) throws SignUpExceptions
	{
		...
		else if(!mSecurityAns.matches()) throw new SignUpExceptions("Securitu Answer should not contain numbers");
		
		else if(udto.getSecurityAns().isBlank()) throw new SignUpExceptions("Securitu Answer should not be blank");
